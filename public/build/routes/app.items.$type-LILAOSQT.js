...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/components/Tables/ItemMetaObjects.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1709719980712.5688";
}
var ItemMetaObjects = ({
  edges,
  pageInfo,
  ...
  const rowMarkup = edges.map(({
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(IndexTable.Cell, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Text, { variant: "bodyMd", as: "span", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: `/app/item/${handle}`, children: truncate(displayName) }, void 0, false, {
...
_s(ItemMetaObjects, "SnZl4qOGazheYiX33WnSXPTvQN0=", false, function() {
  return [useNavigate, useSetIndexFiltersMode];
});
_c = ItemMetaObjects;
var ItemMetaObjects_default = ItemMetaObjects;
var _c;
$RefreshReg$(_c, "ItemMetaObjects");
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/app.items.$type.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1709719980723.6392";
}
function MetaobjectsPage() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Page, { backAction: {
    content: "Products",
    url: "/app"
  }, title: "Items", subtitle: "", compactTitle: true, children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Layout, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Layout.Section, { children: [
    ...
    !pageLoading ? /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(VerticalStack, { gap: "3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(ItemMetaObjects_default, { edges, pageInfo, type, onSearch, loading }, void 0, false, {
      fileName: "app/routes/app.items.$type.tsx",
      lineNumber: 89,
      columnNumber: 15
    }, this) }, void 0, false, {
...
_s2(MetaobjectsPage, "hw0ZAz5gox+37VY09xIX5/4lTOI=", false, function() {
...
//# sourceMappingURL=/build/routes/app.items.$type-LILAOSQT.js.map
