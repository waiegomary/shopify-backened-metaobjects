import {
  require_en,
  styles_default
} from "/build/_shared/chunk-SEK2WCG6.js";
import {
  require_jsx_runtime
...
var require_version = __commonJS({
  "node_modules/@shopify/shopify-api/lib/version.js"(exports) {
    ...
    exports.SHOPIFY_API_LIBRARY_VERSION = "7.5.2";
  }
});
  ...
  "node_modules/@shopify/shopify-api/lib/clients/graphql/storefront_client.js"(exports) {
    ...
    var StorefrontClient = class extends graphql_client_1.GraphqlClient {
      ...
      getApiHeaders() {
        ...
        const privateToken = this.storefrontClass().config.privateAppStorefrontAccessToken;
        if (this.storefrontAccessToken && privateToken) {
          (0, logger_1.logger)(this.storefrontClass().config).warning("You have both private and public storefront access tokens. The private token will be used.");
        }
        const tokenHeaderParam = privateToken === void 0 ? { [types_1.ShopifyHeader.StorefrontAccessToken]: this.storefrontAccessToken } : {
          [types_1.ShopifyHeader.StorefrontPrivateToken]: privateToken
        };
        return Object.assign(Object.assign({}, tokenHeaderParam), { [types_1.ShopifyHeader.StorefrontSDKVariant]: sdkVariant, [types_1.ShopifyHeader.StorefrontSDKVersion]: version_1.SHOPIFY_API_LIBRARY_VERSION });
      }
      storefrontClass() {
        return this.constructor;
      }
...
var require_version3 = __commonJS({
  "node_modules/@shopify/shopify-app-remix/build/cjs/server/version.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var SHOPIFY_REMIX_LIBRARY_VERSION = "1.1.0";
...
// node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/public/authenticate.js
var require_authenticate3 = __commonJS({
  "node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/public/authenticate.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var ensureCorsHeaders = require_ensure_cors_headers();
    var validateSessionToken = require_validate_session_token();
    ...
    function authenticatePublicFactory(params) {
      return async function authenticatePublic(request, options = {}) {
  ...
  "node_modules/@shopify/shopify-app-remix/build/cjs/server/shopify-app.js"(exports) {
    ...
    function shopifyApp(appConfig) {
      ...
      const shopify = {
        ...
        unauthenticated: {
          admin: factory.unauthenticatedAdminContextFactory(params)
        }
      };
...
@remix-run/server-runtime/dist/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=/build/routes/app-3AWGCQ4D.js.map
