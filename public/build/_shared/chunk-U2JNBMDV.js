...
var React3, RemixContext, ABSOLUTE_URL_REGEX3, NavLink2, Link2, linksWarning, useTransitionWarning, fetcherTypeWarning, fetcherSubmissionWarning, isHydrated, LiveReload;
var init_components = __esm({
  "node_modules/@remix-run/react/dist/esm/components.js"() {
    ...
    useTransitionWarning = "\u26A0\uFE0F REMIX FUTURE CHANGE: `useTransition` will be removed in v2 in favor of `useNavigation`. You can prepare for this change at your convenience by updating to `useNavigation`. For instructions on making this change see https://remix.run/docs/en/v1.15.0/pages/v2#usetransition";
    fetcherTypeWarning = "\u26A0\uFE0F REMIX FUTURE CHANGE: `fetcher.type` will be removed in v2. Please use `fetcher.state`, `fetcher.formData`, and `fetcher.data` to achieve the same UX. For instructions on making this change see https://remix.run/docs/en/v1.15.0/pages/v2#usefetcher";
    fetcherSubmissionWarning = "\u26A0\uFE0F REMIX FUTURE CHANGE : `fetcher.submission` will be removed in v2. The submission fields are now part of the fetcher object itself (`fetcher.formData`). For instructions on making this change see https://remix.run/docs/en/v1.15.0/pages/v2#usefetcher";
    isHydrated = false;
        ...
        dangerouslySetInnerHTML: {
          __html: js`
                function remixLiveReloadConnect(config) {
                  let REMIX_DEV_ORIGIN = ${JSON.stringify("https://mph-previews-necessarily-casinos.trycloudflare.com/")};
                  let protocol =
...
var React5, prevRefreshReg, prevRefreshSig, _s, router, hmrAbortController, hmrRouterReadyResolve, hmrRouterReadyPromise, _c;
...
@remix-run/react/dist/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=/build/_shared/chunk-U2JNBMDV.js.map
