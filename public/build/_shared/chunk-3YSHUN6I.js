...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/components/Form/SaveAppBar.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1709719980705.8755";
}
var SaveAppBar = ({
  saveAction,
  discardAction,
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { style: {
    height: "0px"
  }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Frame, { logo: {
    width: 124,
    contextualSaveBarSource: "https://res.cloudinary.com/oves/image/upload/v1657359850/logos/oves_logo_words_h50_w3axpd.png"
  }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ContextualSaveBar, { message: "Unsaved changes", saveAction: {
    onAction: saveAction,
    loading,
    disabled: false
  }, discardAction: {
...
_c = SaveAppBar;
var SaveAppBar_default = SaveAppBar;
var _c;
$RefreshReg$(_c, "SaveAppBar");
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1709719980727.9187";
}
...
var getFieldData = (obj) => {
  return JSON.stringify({
    data: obj
  });
};
var findNode = (data, key) => {
...
var findFieldsNode = (data, key) => {
  return findNode(_.get(data, "fields"), key);
};
var findValueFromFields = (data, key) => {
  return _.get(findFieldsNode(data, key), "value");
};
var getSiteMetadataFieldData = (metaobject, field) => {
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/components/Icons/DeleteIcon.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1709719980708.9888";
}
function DeleteIcon() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Icon, { source: SvgDeleteMajor }, void 0, false, {
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=/build/_shared/chunk-3YSHUN6I.js.map
