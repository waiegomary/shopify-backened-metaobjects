...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/components/Form/Product/ImageForm.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1709719980704.272";
}
var ImageForm = ({
  onAdd,
  activatorTitle
  ...
  const handleValueChange = (0, import_react.useCallback)((value2) => setValue(value2), []);
  const handleSetErrors = (0, import_react.useCallback)((value2) => setErrors(value2), []);
  const handleChange = (0, import_react.useCallback)(() => setActive(!active), [active]);
  const onSubmit = () => {
    handleSetErrors({});
    if (!value) {
  ...
  const activator = /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Button, { size: "micro", onClick: handleChange, children: activatorTitle }, void 0, false, {
    fileName: "app/components/Form/Product/ImageForm.tsx",
    lineNumber: 47,
    columnNumber: 21
  }, this);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Modal, { activator, open: active, onClose: handleChange, title: "Item", primaryAction: {
    content: "Ok",
    onAction: onSubmit
  }, secondaryActions: [{
    content: "Cancel",
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(TextField, { label: "Media URL", value, onChange: handleValueChange, autoComplete: "off", error: errors.value }, void 0, false, {
      fileName: "app/components/Form/Product/ImageForm.tsx",
      lineNumber: 60,
      columnNumber: 13
    }, this),
...
_s(ImageForm, "yPrV743F5/DZA/+pONInK0pZvPg=");
_c = ImageForm;
var ImageForm_default = ImageForm;
var _c;
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/components/ImageGrid.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1709719980709.6677";
}
var ImageGrid = ({
  images,
  onRemove,
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Box, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(HorizontalGrid, { gap: "4", columns: 1, children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(import_react_sortablejs.ReactSortable, { style: {
      display: "grid",
      gridTemplateColumns: "repeat(3, 1fr)",
      gridGap: "10px"
    }, list: images, setList: setImages, children: _.map(images, (image, index2) => {
      return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Card, { padding: "0", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { style: {
        position: "relative",
        height: "100%",
        cursor: "grab"
      }, children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { style: {
          ...
          right: 10,
          top: 10
        }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Button, { size: "micro", onClick: () => {
          onRemove(image);
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("img", { alt: "", width: "100%", height: "100%", style: {
          objectFit: "cover",
          objectPosition: "center"
        }, src: image }, void 0, false, {
          fileName: "app/components/ImageGrid.tsx",
          lineNumber: 57,
          columnNumber: 19
        }, this)
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(HorizontalGrid, { columns: 1, children: (images == null ? void 0 : images.length) === 0 ? /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(EmptyState, { heading: "No image found", image: "https://cdn.shopify.com/s/files/1/0262/4071/2726/files/emptystate-files.png" }, void 0, false, {
      fileName: "app/components/ImageGrid.tsx",
      lineNumber: 67,
      columnNumber: 33
...
_c2 = ImageGrid;
var ImageGrid_default = ImageGrid;
var _c2;
...
classnames/index.js:
  ...
  *)
*/
//# sourceMappingURL=/build/_shared/chunk-M5JWZECC.js.map
