...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1709719980716.0828";
}
var IMAGE_PLACEHOLDER = "https://asset.cloudinary.com/oves/784b06f417dc5e981eaa039cab243564";
var PRODUCT_ID_PREFIX = "gid://shopify/Product/";
var getProductIDNumber = (id) => id == null ? void 0 : id.replace(PRODUCT_ID_PREFIX, "");
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1709719980727.7144";
}
var numberFormat = (n) => {
...
var numberGenerator = () => {
  ...
  return date.getTime() + Math.floor(Math.random() * 5) + Math.floor(Math.random() * 10) + Math.floor(Math.random() * 100) + Math.floor(Math.random() * 100);
};
    ...
    parsed.children.forEach((node) => {
      switch (node.type) {
        case "heading":
          ...
          break;
        case "list":
          html += `<${node.listType === "unordered" ? "ul" : "ol"} class="list">`;
          node.children.forEach((item) => {
            ...
            if (_.get(item, "children")) {
              ...
              item.children.map((it) => {
                if (it.type === "link") {
                  temp += `<a href="${it.url}" target="${it.target}">${it.children[0].value}</a> `;
                } else if (it.type === "link" && it.italic) {
                  temp += `<a href="${it.url}" target="${it.target}"><em>${it.children[0].value}</em></a> `;
            ...
            if ((temp == null ? void 0 : temp.replaceAll(" ", "")) != "<li></li>") {
              html += temp;
            } else {
...
lodash/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=/build/_shared/chunk-HEEBV5QK.js.map
