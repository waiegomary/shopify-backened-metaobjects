 ...
 */
export declare function runConcurrentHTTPProcessesAndPathForwardTraffic({ previewUrl, portNumber, proxyTargets, additionalProcesses, app, abortController, }: Options): Promise<void>;
export {};
