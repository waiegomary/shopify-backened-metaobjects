...
.Polaris-RadioButton__Input_30ock:focus-visible + .Polaris-RadioButton__Backdrop_1x2i2::after { box-shadow: 0 0 0 0.125rem var(--p-color-border-focus); outline: var(--p-border-width-025) solid transparent; }

html[class~="Polaris-Summer-Editions-2023"] .Polaris-RadioButton__Input_30ock:focus-visible + .Polaris-RadioButton__Backdrop_1x2i2 { /* stylelint-disable-next-line polaris/border/polaris/at-rule-disallowed-list -- se23 radio overrides */ outline: var(--p-border-width-050) solid var(--p-color-border-focus); outline-offset: var(--p-space-025); }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-RadioButton__Input_30ock:checked:not([disabled]) + .Polaris-RadioButton__Backdrop_1x2i2, html[class~="Polaris-Summer-Editions-2023"] .Polaris-RadioButton__ChoiceLabel_16hp3:hover .Polaris-RadioButton__Input_30ock:checked:not([disabled]) + .Polaris-RadioButton__Backdrop_1x2i2 { background-color: var(--p-color-bg-primary); border-color: var(--p-color-input-border-active); }

.Polaris-RadioButton__ChoiceLabel_16hp3:hover .Polaris-RadioButton__Input_30ock + .Polaris-RadioButton__Backdrop_1x2i2 { cursor: pointer; border-color: var(--p-color-input-border-hover); }

html[class~="Polaris-Summer-Editions-2023"] .Polaris-RadioButton__ChoiceLabel_16hp3:hover .Polaris-RadioButton__Input_30ock + .Polaris-RadioButton__Backdrop_1x2i2 { background: var(--p-color-input-bg-surface-hover); }

html[class~="Polaris-Summer-Editions-2023"] .Polaris-RadioButton__ChoiceLabel_16hp3:active .Polaris-RadioButton__Input_30ock + .Polaris-RadioButton__Backdrop_1x2i2 { border-color: var(--p-color-bg-primary); border-width: var(--p-border-width-050); }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-RadioButton__Backdrop_1x2i2 { border-width: var(--p-border-width-0165); background-color: var(--p-color-input-bg-surface); transition: border-color var(--p-motion-duration-100) var(--p-motion-ease-out); }
