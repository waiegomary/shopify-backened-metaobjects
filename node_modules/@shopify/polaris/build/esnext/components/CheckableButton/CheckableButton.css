...
.Polaris-CheckableButton__Label_2vd36 { flex: 1 1; white-space: nowrap; overflow: hidden; max-width: 100%; text-overflow: ellipsis; padding: var(--p-space-025) 0; margin-left: calc(var(--p-space-500) - var(--p-border-width-050)); }

html[class~="Polaris-Summer-Editions-2023"] .Polaris-CheckableButton__Label_2vd36 { margin-left: calc(var(--p-space-300) + var(--p-space-025)); line-height: 1.125rem; }
