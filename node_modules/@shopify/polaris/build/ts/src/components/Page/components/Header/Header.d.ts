...
export declare function Header({ title, subtitle, titleMetadata, additionalMetadata, titleHidden, primaryAction, pagination, filterActions, additionalNavigation, backAction, secondaryActions, actionGroups, compactTitle, onActionRollup, }: HeaderProps): React.JSX.Element;
export {};
