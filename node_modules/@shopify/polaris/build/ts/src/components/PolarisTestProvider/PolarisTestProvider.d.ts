...
export declare function PolarisTestProvider({ strict, children, i18n, link, mediaQuery, features, frame, indexFilters, }: PolarisTestProviderProps): React.JSX.Element;
export {};
