...
var context$7 = require('../../utilities/index-filters/context.js');
var types = require('../../utilities/index-filters/types.js');
...
const defaultIndexFilters = {
  mode: types.IndexFiltersMode.Default,
  setMode: noop
};
function PolarisTestProvider({
  ...
  const mergedIndexFilters = merge.merge(defaultIndexFilters, indexFilters);
  return /*#__PURE__*/React.createElement(Wrapper, null, /*#__PURE__*/React.createElement(context.FeaturesContext.Provider, {
    ...
    value: mergedFrame
  }, /*#__PURE__*/React.createElement(context$7.IndexFiltersModeContext.Provider, {
