...
declare const renderConfirmationPromptStepSchema: zod.ZodObject<{
    ...
    properties: zod.ZodObject<{
        message: zod.ZodUnion<[zod.ZodType<string | {
            command: string;
        } | {
            char: string;
        } | {
        ...
        infoTable: zod.ZodOptional<zod.ZodUnion<[zod.ZodObject<{}, "strip", zod.ZodArray<zod.ZodUnion<[zod.ZodType<string | {
            ...
            bullet: zod.ZodOptional<zod.ZodString>;
        ...
        gitDiff: zod.ZodOptional<zod.ZodObject<{
            baselineContent: zod.ZodString;
            updatedContent: zod.ZodString;
        }, "strip", zod.ZodTypeAny, {
