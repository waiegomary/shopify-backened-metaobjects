...
declare const ALL_HEADING_LEVELS: readonly [1, 2, 3, 4, 5, 6];
export type HEADING_LEVEL = (typeof ALL_HEADING_LEVELS)[number];
/**
 * @internal
 */
export declare const headingsSystem: SystemSpec<[SystemSpec<[], (r: Realm) => {
 ...
 * @internal
 */
export declare const headingsPlugin: PluginConstructor<SystemSpec<[SystemSpec<[], (r: Realm) => {
    activeEditor: RealmNode<LexicalEditor | null>;
    inFocus: RealmNode<boolean>;
    historyState: RealmNode<HistoryState>;
    currentSelection: RealmNode<RangeSelection | null>;
    ...
    allowedHeadingLevels: RealmNode<readonly (1 | 2 | 4 | 3 | 5 | 6)[]>;
}>, HeadingsPluginParams>, headingsPluginHooks: {
