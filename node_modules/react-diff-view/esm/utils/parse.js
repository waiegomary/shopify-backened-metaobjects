...
export function isInsert(change) {
    return change.type === 'insert';
}
export function isDelete(change) {
    return change.type === 'delete';
}
export function isNormal(change) {
    return change.type === 'normal';
}
function zipChanges(changes) {
    const [result] = changes.reduce(([result, last, lastDeletionIndex], current, i) => {
        if (!last) {
            result.push(current);
